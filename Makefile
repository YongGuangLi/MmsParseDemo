...
$(PROJECT_BINARY_NAME):	$(PROJECT_OBJS) $(LIB_NAME) $(PCAP_LIB) $(LOG_LIB) $(MYSQL_LIB) $(PROTOBUF_LIB) $(BOOST_SYSTEM_LIB) $(BOOST_FILESYSTEM_LIB) $(BOOST_REGEX_LIB) $(ACL_CPP_LIB) $(ACL_LIB) 
	$(CPP) $(CFLAGS) $(LDFLAGS) -o $(PROJECT_BINARY_NAME) -g $(PROJECT_OBJS) $(INCLUDES) $(LIB_NAME) $(PROTOBUF_LIB) $(PCAP_LIB) $(LOG_LIB) $(MYSQL_LIB) $(BOOST_SYSTEM_LIB) $(BOOST_FILESYSTEM_LIB) $(BOOST_REGEX_LIB) $(BOOST_THREAD_LIB) $(ACL_CPP_LIB) $(ACL_LIB) $(LDLIBS)  
